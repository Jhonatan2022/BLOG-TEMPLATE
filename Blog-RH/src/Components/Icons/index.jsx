...
function CommentIcon({ color, size }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
LikeIcon.propTypes = IconsPropTypes;
...
SunIcon.propTypes = IconsPropTypes;
MoonIcon.propTypes = IconsPropTypes;
